            ...
            <DropdownMenuContent align="end" className="w-80">
              ...
              <div className="space-y-2 p-2">
                <div className="p-2 rounded-md bg-muted/50">
                  <p className="text-sm font-medium">New room change request</p>
                  <p className="text-xs text-muted-foreground">From Alex Thompson - Room 205</p>
                </div>
                <div className="p-2 rounded-md bg-muted/50">
                  <p className="text-sm font-medium">Maintenance completed</p>
                  <p className="text-xs text-muted-foreground">AC repair in Block A</p>
                </div>
                <div className="p-2 rounded-md bg-muted/50">
                  <p className="text-sm font-medium">Fee payment received</p>
                  <p className="text-xs text-muted-foreground">Monthly fee for March</p>
                </div>
              </div>
            </DropdownMenuContent>
          </DropdownMenu>
